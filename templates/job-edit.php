...
<div class="form-group">
    ...
    <textarea name="description" class="form-control"> <?php echo $job->jobtitle;?> </textarea>      
</div>
...
<div class="form-group">
    ...
    <input type="text" name="contactemail" class="form-control" value="<?php echo $job->contactemail;?>">       
</div>
