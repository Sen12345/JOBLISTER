...
<hr>
<p class="leed"> <?php echo $job->description?></p>
<ul class="list-group">
    <li class="list-group-item"><strong><?php echo $job->company;?></strong> </li>
...
<br />
<div class="well">
<a href="edit.php?id=<?php echo $job->jobID;?>" class="btn btn-success">Edit</a>
